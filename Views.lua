ViewSettings = {
	...
	[1] = {-- player slot 1
		...
		CameraAngleLimits      = {175,-80,110}, -- Vue Droite/gauche Vue, Bas, Haut
		limits_6DOF            = {x = {-0.05,0.25},y = {-0.2,0.1},z = {-0.17,0.17},roll = 70.000000}, --Mouvements avant/arrière, haut/bas, droite/gauche z = {-0.200000,0.200000}
